...
/******************************************
 * calculate temp variable T1 and T2
 * ***************************************/
...
void hmac_sha256_pad(u32 w0[4], u32 w1[4], u32 w2[4], u32 w3[4], u32 T1[8], u32 T2[8])
{
  ...
  sha256_transform (w0, w1, w2, w3, T1);
  ...
  sha256_transform (w0, w1, w2, w3, T2);
}
...
{
	u32 w0[4],w1[4],w2[4],w3[4],T1[8],T2[8];
	int i;
	for(i=0;i<4;i++){
		w0[i]=pwd[i];
		w1[i]=pwd[i+4];
	...
	hmac_sha256_run (w0, w1, w2, w3, T1, T2, Result);
}